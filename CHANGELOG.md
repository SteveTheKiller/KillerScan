...
### Added
- Permanent views use glyphs with captions on the right of the scan toolbar and switch between scans, topology, connection monitoring, and a full-width terminal while preserving their state.
