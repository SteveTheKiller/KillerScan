...
### Fixed
- Restored network information and toolbar background, simplified navigation and filtering, unified the footer status, themed service and history tables, and fixed the SSH username dialog crash.
